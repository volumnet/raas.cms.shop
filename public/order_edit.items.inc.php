      ...
      <table class="table table-striped" data-role="raas-repo-block">
        <thead>
          <tr>
            ...
            <th><?php echo Module::i()->view->_('MATERIAL')?></th>
        ...
        <tbody data-role="raas-repo-container">
          <?php foreach ((array)$DATA['material'] as $key => $materialId) {
              ...
              <tr data-role="raas-repo-element">
                ...
                <td>
                  <input datatype="material" type="hidden" data-cart-type-id="<?php echo $FieldSet->meta['Cart_Type']->id?>" data-material-id="<?php echo (int)$DATA['material'][$key]?>" data-material-name="<?php echo htmlspecialchars((new Material($DATA['material'][$key]))->name)?>" name="material[]" value="<?php echo (int)$DATA['material'][$key]?>" />
                </td>
                <td>
                  <input type="text" class="span2" name="material_name[]" value="<?php echo htmlspecialchars($DATA['material_name'][$key] ?? '')?>" />
                </td>
                <td>
                  <input type="text" class="span2" name="meta[]" value="<?php echo htmlspecialchars($DATA['meta'][$key])?>" />
                </td>
                <td>
                  <input type="number" name="realprice[]" step="0.01" style="width: 5em" value="<?php echo (float)$DATA['realprice'][$key]?>" />
                </td>
                <td>
        ...
        <tbody>
          <tr data-role="raas-repo">
            ...
            <td>
              <input type="text" class="span2" name="material_name[]" disabled />
            </td>
            <td>
              <input type="text" class="span2" name="meta[]" disabled="disabled" />
            </td>
            <td>
              <input type="number" name="realprice[]" step="0.01" style="width: 5em" disabled="disabled" />
            </td>
            <td>
