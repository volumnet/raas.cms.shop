...
if ($_GET['AJAX'] == $Block->id) {
    ...
    <div class="goods-comments goods-comments__list goods-comments-list" data-vue-role="goods-comments" data-v-bind_block-id="<?php echo (int)$Block->id?>" data-v-slot="commentsVm">
      <?php foreach ($Set as $comment) { ?>
          <div data-vue-role="goods-comments-item" data-v-bind_item-id="<?php echo (int)$comment->id?>" data-v-slot="itemVm" class="goods-comments-list__item goods-comments-item" id="comment<?php echo (int)$comment->id?>">
            ...
            <div class="goods-comments-item__is-useful">
              ...
              <div class="goods-comments-item__is-useful-votes-list goods-comments-item-is-useful-votes-list">
                <button type="button"
                  class="goods-comments-item-is-useful-votes-list__item goods-comments-item-is-useful-votes-item goods-comments-item-is-useful-votes-item_pros"
                  data-v-bind_class="{ 'goods-comments-item-is-useful-votes-item_voted': itemVm.voted, 'goods-comments-item-is-useful-votes-item_active': (itemVm.voted > 0) }"
                  data-v-html="itemVm.votesRetrieved ? itemVm.pros : ''"
                  data-v-on_click="commentsVm.vote(<?php echo (int)$comment->id?>, 1)"
                ></button>
                <button type="button"
                  class="goods-comments-item-is-useful-votes-list__item goods-comments-item-is-useful-votes-item goods-comments-item-is-useful-votes-item_cons"
                  data-v-bind_class="{ 'goods-comments-item-is-useful-votes-item_voted': itemVm.voted, 'goods-comments-item-is-useful-votes-item_active': (itemVm.voted < 0) }"
