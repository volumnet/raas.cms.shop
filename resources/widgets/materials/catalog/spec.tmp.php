...
if ($Set) { ?>
    <div class="spec">
      ...
      <?php } ?>
      <div
        class="spec__inner slider slider_horizontal"
      ...
      >
        <button
          ...
          class="spec__arrow spec__arrow_prev slider__arrow slider__arrow_prev"
          data-v-bind_class="{ 'spec__arrow_active': vm.prevAvailable, 'slider__arrow_active': vm.prevAvailable }"
        ></button>
        <div class="spec__list slider__list" data-role="slider-list">
          <div class="spec-list slider-list slider-list_horizontal">
            <?php foreach ((array)$Set as $i => $item) { ?>
                <div
                  class="spec-list__item slider-list__item"
                  data-role="slider-item"
                  data-slider-index="<?php echo (int)$i?>"
                  data-v-bind_class="{
                      'spec-list__item_active': (vm.activeFrame == <?php echo $i?>),
        ...
        <button
          ...
          class="spec__arrow spec__arrow_next slider__arrow slider__arrow_next"
          data-v-bind_class="{ 'spec__arrow_active': vm.nextAvailable, 'slider__arrow_active': vm.nextAvailable }"
        ></button>
      </div>
    </div>
    <?php
